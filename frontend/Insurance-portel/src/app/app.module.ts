...
import { MatRippleModule,MatButtonModule,MatMenuModule, MatToolbarModule,
        MatIconModule,MatCardModule, MatExpansionModule, MatFormFieldModule,MatInputModule,
...
@NgModule({
  ...
  imports: [
    ...
    BrowserModule,
    AppRoutingModule,
    HttpModule, HttpClientModule, MatRippleModule,
    MatButtonModule,
    MatMenuModule,
     MatToolbarModule,
     MatIconModule,
     MatCardModule,BrowserAnimationsModule, MatExpansionModule,
